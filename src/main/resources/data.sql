...
-- Insert blog posts
INSERT INTO blog_post (blog_post_title, blog_post_text, user_id) VALUES
                                                                     ('First Blog Post', 'This is the first blog post.', 1),
...
INSERT INTO blog_post_tags (blog_post_id, tag_id) VALUES
                                                      (1, 1),  -- First Blog Post is tagged with Technology
